...
<h1 style="text-align:center;"> Evaluación Negociación</h1>
...
<?php
			...
			$sentencia2 = "SELECT *
            FROM evaluacion            
			where ID_PROYECTO='$id' AND ID_FASE=8;";
			...
			$resultado4 = mysqli_query($enlace,$sentencia3);
			...
			echo "<form  id='1' action='editNeg.php' method='POST'>";
			/* USO DE " READONLY "*/
			
			echo "<tr><td >ID Proyecto: </td><td ><input style='width: 290px;' name='id_proy' type='number' value='$fila[0]' readonly></td>
			<td rowspan='7'>Estado de Convenio:</td><td align='center' rowspan='7'> ";
			if ($estado0=='APROBADO') {
			...
			echo "<tr><td >CUMPLE CONDICIONES DE EFECTIVIDAD</td><td align='center'>";
            ...
            echo "<tr><td>CONVENIO FIRMADO:</td><td align='center'> ";
            if ($evals[1]=='SI') {
            ...
            echo "<tr><td >Inicio de Convenio:</td><td > <input style='width: 290px;' name='inicio' type='date' value='$evals[2]??=Falta evaluar'> </td></tr>";
            echo "<tr><td >Fin de Convenio:</td><td > <input style='width: 290px;' name='fin' type='date' value='$evals[3]??=Falta evaluar'> </td></tr>";
