...
<h1 style="text-align:center;"> REVISIÓN FASE 3 </h1>
...
if(isset($_POST['insertar_id'])){ //check if form was submitted
  $id_concurso = $_POST['id_concurso']; //get input text
            ...
            WHERE P.ID_CONCURSO = $id_concurso AND E.ID_FASE=4 
                AND (E.ESTADO ='APROBADO' OR E.ESTADO ='APROBADO SUJETO A AJUSTES')
            ...
            if ($numFilas == 0) {
              ...
              for ($i=1; $i <= $numFilas; $i++){
                ...
                $sentencia3= " SELECT *
                            FROM evaluacion
                            WHERE ID_PROYECTO=$registro[0] AND ID_FASE='5'
                            ORDER BY ID_CRITERIO;";
                ...
                echo "		<td rowspan='$numFilas2'><a href='editarRev.php?id=$registro[0]&num=$numFilas2'>Evaluar </a></td>";
