...
<h1 style="text-align:center;"> Evaluación Revisión Fase 3</h1>
...
<?php
			...
			$sentencia2 = "SELECT *
            FROM evaluacion            
			where ID_PROYECTO='$id' AND ID_FASE=5;";
			...
			echo "<form  id='1' action='editRev.php' method='POST'>";
			/* USO DE " READONLY "*/
			...
			echo "<tr><td >APROBACIÓN DEL DE</td><td align='center'>";
            ...
            echo "<tr><td>APROBACIÓN DE FUENTE FINANCIERA:</td><td align='center'> ";
            if ($evals[1]=='SI') {
