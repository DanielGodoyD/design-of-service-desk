...
<h1 style="text-align:center;"> Evaluación Fase 1  </h1>
...
<?php
			...
			$sentencia2 = "SELECT *
            FROM evaluacion            
			where ID_PROYECTO='$id' AND ID_FASE=2;";
			...
			echo "<form  id='1' action='editFase_1.php' method='POST'>";
			/* USO DE " READONLY "*/
			
			echo "<tr><td >ID Proyecto: </td><td ><input style='width: 290px;' name='id_proy' type='number' value='$fila[0]' readonly></td>
			<td rowspan='7'>Estado de Fase 1:</td><td align='center' rowspan='7'> ";
			if ($estado0=='APROBADO') {
			...
			echo "<tr><td >¿DOCUMENTOS COMPLETOS?</td><td align='center'>";
			
			if ($evals[0]=='SI') {
				echo "<input name='doc_ok' type='radio' value='SI' checked>SI";
				echo "<input name='doc_ok' type='radio' value='NO'>NO </td>
				...
				echo "<input name='doc_ok' type='radio' value='SI'>SI";
				echo "<input name='doc_ok' type='radio' value='NO' checked>NO </td>
				<td rowspan='$num'>Comentarios: </td>
