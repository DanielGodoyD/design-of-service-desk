...
<h1 style="text-align:center;"> FASE 3 </h1>
      ...
      <div class="table-horizontal-container">
        <table class="unfixed-table">
          ...
          <tr><th>ID Proyecto</th><th>Nombre Proyecto</th><th>ID de Concurso</th>
            ...
            <th>Puntaje Promedio</th><th> Estado </th>
...
if(isset($_POST['insertar_id'])){ //check if form was submitted
  $id_concurso = $_POST['id_concurso']; //get input text
            ...
            D.ID_PROPONENTE, NOMBRES, APELLIDOS, CORREO, E.ESTADO
            FROM proyectos AS P 
            JOIN proponente AS D            
            ON P.ID_PROPONENTE = D.ID_PROPONENTE
            JOIN eva_fase AS E
            ON P.ID_PROYECTO = E.ID_PROYECTO
            WHERE P.ID_CONCURSO = $id_concurso AND E.ID_FASE=3 AND E.ESTADO ='APROBADO'
            ...
            if ($numFilas == 0) {
              echo "No existen proyectos Aprobados para este Concurso <br>";
            }
            else {
              ...
              for ($i=1; $i <= $numFilas; $i++){
                ...
                $sentencia3= " SELECT *
                            FROM evaluacion
                            WHERE ID_PROYECTO=$registro[0] AND ID_FASE='4'
                            ORDER BY ID_CRITERIO;";
                  ...
                  $yesno = array();
                                    for ($m=1; $m <= $numFilas2; $m++){
                                      ...
                                      $registro3 = mysqli_fetch_row($resultado3);                            
                                        ...
                                        if($registro3){	 
                                           	/* aca se necesita el puntaje (columna 5) y no los 'SI/NO' */
                                            $yesno[]= $registro3[5];
                                        } else {
                                            $yesno[]='Falta evaluar';
                                        }	
                ...
                echo "		<td rowspan='$numFilas2'><a href='editarFase3.php?id=$registro[0]&num=$numFilas2'>Evaluar </a></td>";
