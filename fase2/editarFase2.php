...
<h1 style="text-align:center;"> Evaluación Fase 2 </h1>
...
<?php
			...
			$sentencia2 = "SELECT *
            FROM evaluacion            
			where ID_PROYECTO='$id' AND ID_FASE=3;";
			...
			echo "<form  id='1' action='editFase2.php' method='POST'>";
			/* USO DE " READONLY "*/
			
			echo "<tr><td >ID Proyecto: </td><td ><input style='width: 290px;' name='id_proy' type='number' value='$fila[0]' readonly></td>
			<td rowspan='7'>Estado de Fase 2:</td><td align='center' rowspan='7'> ";
			if ($estado0=='APROBADO') {
			...
			echo "<tr><td >APRUEBA CRITERIO 1</td><td align='center'>";
            ...
            echo "<tr><td>APRUEBA CRITERIO 2:</td><td align='center'> ";
            if ($evals[1]=='SI') {
				echo "<input name='cr2' type='radio' value='SI' checked>SI";
				echo "<input name='cr2' type='radio' value='NO'>NO </td></tr>";
			}
			else {
				echo "<input name='cr2' type='radio' value='SI'>SI";
				echo "<input name='cr2' type='radio' value='NO' checked>NO </td></tr>";
			}
			
            echo "<tr><td>ESTÁNDARES:</td><td align='center'> ";
            if ($evals[2]=='SI') {
				echo "<input name='ests' type='radio' value='SI' checked>SI";
				echo "<input name='ests' type='radio' value='NO'>NO";
			}
			else {
				echo "<input name='ests' type='radio' value='SI'>SI";
				echo "<input name='ests' type='radio' value='NO' checked>NO </td></tr>";
			}
			
            echo "<tr><td>POLÍTICA AMBIENTAL:</td><td align='center'> ";
            if ($evals[3]=='SI') {
				echo "<input name='p_amb' type='radio' value='SI' checked>SI";
				echo "<input name='p_amb' type='radio' value='NO'>NO";
			}
			else {
				echo "<input name='p_amb' type='radio' value='SI'>SI";
				echo "<input name='p_amb' type='radio' value='NO' checked>NO </td></tr>";
			}

			echo "<tr><td>POLÍTICA GÉNERO:</td><td align='center'> ";
            if ($evals[4]=='SI') {
				echo "<input name='p_gen' type='radio' value='SI' checked>SI";
				echo "<input name='p_gen' type='radio' value='NO'>NO";
			}
			else {
				echo "<input name='p_gen' type='radio' value='SI'>SI";
				echo "<input name='p_gen' type='radio' value='NO' checked>NO </td></tr>";
			}

			echo "<tr><td>POLÍTICA SOCIAL:</td><td align='center'> ";
            if ($evals[5]=='SI') {
				echo "<input name='p_soc' type='radio' value='SI' checked>SI";
				echo "<input name='p_soc' type='radio' value='NO'>NO";
			}
			else {
				echo "<input name='p_soc' type='radio' value='SI'>SI";
				echo "<input name='p_soc' type='radio' value='NO' checked>NO </td></tr>";
			}
