...
<h1 style="text-align:center;"> Evaluación Fase 4</h1>
...
<?php
			...
			$sentencia2 = "SELECT *
            FROM evaluacion            
			where ID_PROYECTO='$id' AND ID_FASE=7;";
			...
			echo "<form  id='1' action='editFase4.php' method='POST'>";
			/* USO DE " READONLY "*/
			
			echo "<tr><td >ID Proyecto: </td><td ><input style='width: 290px;' name='id_proy' type='number' value='$fila[0]' readonly></td>
			<td rowspan='7'>Estado de Fase 4:</td><td align='center' rowspan='7'> ";
			if ($estado0=='APROBADO') {
