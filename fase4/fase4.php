...
<h1 style="text-align:center;"> FASE 4</h1>
...
if(isset($_POST['insertar_id'])){ //check if form was submitted
  $id_concurso = $_POST['id_concurso']; //get input text
            ...
            WHERE P.ID_CONCURSO = $id_concurso AND (E.ID_FASE=5 OR E.ID_FASE=6 ) AND E.ESTADO ='APROBADO'
            ...
            if ($numFilas == 0) {
              ...
              for ($i=1; $i <= $numFilas; $i++){
                ...
                $sentencia3= " SELECT *
                            FROM evaluacion
                            WHERE ID_PROYECTO=$registro[0] AND ID_FASE='7'
                            ORDER BY ID_CRITERIO;";
                ...
                echo "		<td rowspan='$numFilas2'><a href='editarFase4.php?id=$registro[0]&num=$numFilas2'>Evaluar </a></td>";
